" File:       vim-color-molokini.vim
" Maintainer: Mahesh Asolkar (asolkar)
" URL:        https://github.com/asolkar/vim-color-molokini
" License:    MIT
"
" Color palette inspired from https://github.com/pR0Ps/molokai-dark
" Original code is from https://github.com/crusoexia/vim-monokai
...
if ! exists("g:molokini_gui_italic")
  let g:molokini_gui_italic = 1
endif

if ! exists("g:molokini_term_italic")
  let g:molokini_term_italic = 0
endif

let g:molokini_termcolors = 256 " does not support 16 color term right now.
...
function! s:h(group, style)
  ...
  if g:molokini_term_italic == 0
    let s:ctermformat = substitute(s:ctermformat, ",italic", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic,", "", "")
    let s:ctermformat = substitute(s:ctermformat, "italic", "", "")
  endif
  if g:molokini_gui_italic == 0
    let s:guiformat = substitute(s:guiformat, ",italic", "", "")
    let s:guiformat = substitute(s:guiformat, "italic,", "", "")
    let s:guiformat = substitute(s:guiformat, "italic", "", "")
  endif
  if g:molokini_termcolors == 16
...
let s:white       = { "gui": "#F8F8F2", "cterm": "15" }
let s:white2      = { "gui": "#66D9EF", "cterm": "81" }
let s:black       = { "gui": "#000000", "cterm": "0" }
let s:lightblack  = { "gui": "#232526", "cterm": "236" }
let s:lightblack2 = { "gui": "#1C1C1C", "cterm": "234" }
...
let s:yellow      = { "gui": "#FFDF5F", "cterm": "221" }
let s:orange      = { "gui": "#FD971F", "cterm": "208" }
let s:purple      = { "gui": "#7070F0", "cterm": "141" }
let s:red         = { "gui": "#F92672", "cterm": "196" }
